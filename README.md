...
Desenvolvido por Alessandra da Silveira

🔗 LinkedIn: https://www.linkedin.com/in/alessandra-silveiras/

🐙 GitHub: https://github.com/allsilveira
...
```bash
# Clone o repositório
git clone https://github.com/allsilveira/agua-vida-dashboard.git

# Acesse a pasta do projeto
cd agua-vida-dashboard
