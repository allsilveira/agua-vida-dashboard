...
import { Package, User, LogOut, Menu, X, GlassWater } from "lucide-react";
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 border-b flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-gradient-to-br from-primary rounded-xl flex items-center justify-center">
            <GlassWater className="w-6 h-6 text-primary-foreground" />
          </div>
          <div>
            <h1 className="font-bold text-lg">Dashboard</h1>
